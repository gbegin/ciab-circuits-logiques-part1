...
chaque sortie possible et un minterm.

![img]({{site.baseurl}}/img/decod3_8.svg "Circuit du décodeur trois-vers-huit")
*Circuit du décodeur trois-vers-huit*

<table id="org8b52f3d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Tableau 1 :</span> Tableau de vérité du décodeur trois-vers-huit</caption>
...
![img]({{site.baseurl}}/img/decode2_4_enable.svg "Décodeur à sortie active basse")
...
![img]({{site.baseurl}}/img/fonct_arbit_decod.svg "Fonction arbitraire")
*Fonction arbitraire*

<table id="org1b2ec95" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Tableau 3 :</span> Tableau de vérité pour la fonction arbitraire</caption>
