...
aurons donc le complément à 10 et le complément à 9. Pour les nombres
...
## Complément à 9 et complément à un

Soit un nombre entier $$N$$ en base $$b$$ constitué de $$n$$ chiffres. Le
complément à $$b-1$$ de $$N$$ est $$(b^n-1)-N$$.

Par exemple en base $$b=10$$, le complément à 9 pour le nombre décimal
...
## Complément à 10 et complément à deux

Le complément à $$b$$ de l'entier $$N$$ s'évalue comme
$$(b^n)-N$$. Cela correspond à ajouter 1 au complément à $$b-1$$.

Ainsi pour notre exemple précédent en base $$b=10$$, le complément à 10 pour le nombre
...
<caption class="t-above"><span class="table-number">Tableau 8 :</span> Étape pour complément à deux</caption>
...
si on veut pouvoir représenter les valeurs comprises entre $$-10$$ et
...
Nous devons donc prévoir suffisamment de combinaisons de bits qu'il
...
devrait considérer les points suivants dans notre choix de convention
...
![img](cycle.png "Relations entre les codes dans l'assignation en complément à deux")
